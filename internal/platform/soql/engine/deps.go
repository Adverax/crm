...
type CursorManager interface {
	...
	Next(lastRow map[string]interface{}, namespace string, userID string,
...
type FIDBuilder interface {
	...
	BuildFID(namespace string, userID string, filter map[string]interface{}) string
}
...
func (b *DefaultFIDBuilder) BuildFID(namespace string, userID string, filter map[string]interface{}) string {
