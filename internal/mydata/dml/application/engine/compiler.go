...
type CompiledDML struct {
	...
	// ReturningColumn is the column name to return (usually record_id)
...
// Generates: INSERT INTO table (col1, col2) VALUES ($1, $2), ($3, $4) RETURNING record_id
...
// Generates: UPDATE table SET col1 = $1, col2 = $2 WHERE ... RETURNING record_id
...
// Generates: DELETE FROM table WHERE ... RETURNING record_id
