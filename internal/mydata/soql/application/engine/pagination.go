...
// Uses record_id as the unique identifier for stable pagination.
const DefaultTieBreaker = "record_id"
...
type PaginationConfig struct {
	...
	// TieBreaker is the field name used as tie-breaker (default: "record_id").
	TieBreaker string
}
