// CEL Expression Editor — Custom Function Registry (Go)
//
// Thread-safe registry that precompiles custom function bodies and registers
// them as fn.* overloads in CEL environments.
//
// Dependencies:
...
// It is thread-safe for concurrent read access after initialization.
...
// Returns an error if any function body fails to compile.
...
// in a CEL environment. Call this when building an environment that needs
